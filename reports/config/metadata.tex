...
\newcommand{\ReportSubject}{ĐỒ ÁN HỌC PHẦN: AN TOÀN THÔNG TIN}
\newcommand{\ReportMajor}{Ngành: Công nghệ Thông tin}

\newcommand{\ReportAuthor}{NGUYỄN ĐỨC ANH}
\newcommand{\ReportStudentID}{2026-2027}
\newcommand{\ReportClass}{CNTT}

\newcommand{\ReportSupervisor}{TS. GIẢNG VIÊN HƯỚNG DẪN}
