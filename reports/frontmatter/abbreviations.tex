...
\textbf{Cross-Subtype Generalization} & Đánh giá khả năng áp dụng mô hình sang subtype khác; cần nêu rõ subtype có xuất hiện trong dữ liệu chọn mô hình hay không \\
\textbf{Data Leakage} & Rò rỉ thông tin nhãn hoặc đặc trưng giữa các tập hay giữa các giai đoạn huấn luyện và đánh giá \\
...
\textbf{Optimistic Evaluation Bias} & Ước lượng hiệu năng quá lạc quan; có thể phát sinh khi giao thức đánh giá không phản ánh mục tiêu triển khai, chẳng hạn do phụ thuộc giữa các mẫu \\
...
\textbf{Temporal Split} & Phân chia dữ liệu theo thứ tự thời gian được ghi nhận hoặc tái dựng; cần công bố giới hạn về nguồn timestamp \\
