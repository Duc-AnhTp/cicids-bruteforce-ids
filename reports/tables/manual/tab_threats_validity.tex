...
\midrule
\textbf{Tính hợp lệ thống kê}\newline(\textit{Statistical Validity}) & Tỷ lệ tấn công thấp ($2\% -- 5\%$) gây nhiễu chỉ số Accuracy. & Sử dụng F1-Score, đường cong Precision-Recall, AP và FPR làm hệ quy chiếu cốt lõi; loại bỏ sự phụ thuộc vào nghịch lý độ chính xác (Accuracy Paradox). \\
\bottomrule
\end{tabular}%
}
\end{table}
