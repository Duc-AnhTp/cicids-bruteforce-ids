\begin{table}[htbp]
\centering
\caption{Top 10 đặc trưng mạng có đóng góp lớn nhất vào quyết định phân loại theo giá trị SHAP trung bình.}
...
\midrule
1 & \texttt{Destination Port} & 0.1237 & Cổng đích dịch vụ (Port 21 FTP, Port 22 SSH) \\
2 & \texttt{Fwd Packet Length Std} & 0.0339 & Độ lệch chuẩn kích thước gói tin hướng đi (Fwd) \\
...
6 & \texttt{min_seg_size_forward} & 0.0272 & Kích thước header TCP tối thiểu phía forward \\
