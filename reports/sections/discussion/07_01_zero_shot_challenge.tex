...
Sự sụp đổ của cả 3 mô hình học máy dạng cây trên tập Test theo thời gian ($\FOne \le \RFTestFOne$) là phát hiện khoa học mang tính thực tiễn cao nhất của nghiên cứu này. Trong khi các nghiên cứu trước đây thường che giấu hoặc tránh né kịch bản này, chúng tôi khẳng định đây là một hiện tượng tự nhiên và tất yếu bắt nguồn từ \textbf{Sự dịch chuyển phân phối của các biến thể tấn công (Subtype Distribution Shift)}:
