...
Do đó, theo thứ tự ưu tiên lựa chọn đã thiết lập, \textbf{Random Forest (\texttt{time/with\_port})} được chọn là mô hình đại diện cho kịch bản đánh giá chính để tiến hành đánh giá trên tập kiểm thử $\Dtest$.
