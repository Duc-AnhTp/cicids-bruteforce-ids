...
Để kiểm chứng giả thuyết cho rằng mô hình gặp khó khăn trên tập Test theo thời gian chỉ đơn thuần là do dựa vào lối tắt cổng dịch vụ đích, nhóm tiến hành phân tích kịch bản bóc tách cổng, trong đó đặc trưng này bị loại bỏ khỏi không gian huấn luyện.
...
Khi quan sát kết quả trên tập kiểm thử $\Dtest$ theo thời gian (xem Phần A của Bảng \ref{tab:test_comparison}):
\begin{itemize}
    \item Decision Tree: Điểm F1 tăng nhẹ từ \DTTestFOne\ lên \DTTestWithoutPortFOne, nhận diện được \DTTestWithoutPortSSHRecall\ tấn công SSH (7 mẫu).
    \item Random Forest: Điểm F1 tăng từ \RFTestFOne\ lên \RFTestWithoutPortFOne, nhận diện được \RFTestWithoutPortSSHRecall\ tấn công SSH (14 trên tổng số \DataTestSSH\ mẫu).
    \item XGBoost: Điểm F1 tăng từ \XGBTestFOne\ lên \XGBTestWithoutPortFOne, nhận diện được \XGBTestWithoutPortSSHRecall\ tấn công SSH (13 trên tổng số \DataTestSSH\ mẫu).
\end{itemize}
