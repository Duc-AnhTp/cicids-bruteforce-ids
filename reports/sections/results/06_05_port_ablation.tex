...
\begin{itemize}
    \item \textbf{Cây Quyết Định (Decision Tree)}: Điểm F1 tăng nhẹ từ \DTTestFOne\ lên \textbf{\DTTestWithoutPortFOne}, nhận diện được \DTTestWithoutPortSSHRecall\ tấn công SSH (7 mẫu).
    \item \textbf{Rừng Ngẫu Nhiên (Random Forest)}: Điểm F1 tăng từ \RFTestFOne\ lên \textbf{\RFTestWithoutPortFOne}, nhận diện được \RFTestWithoutPortSSHRecall\ tấn công SSH (14 trên tổng số \DataTestSSH\ mẫu).
    \item \textbf{XGBoost}: Điểm F1 tăng từ \XGBTestFOne\ lên \textbf{\XGBTestWithoutPortFOne}, nhận diện được \XGBTestWithoutPortSSHRecall\ tấn công SSH (13 trên tổng số \DataTestSSH\ mẫu).
\end{itemize}
