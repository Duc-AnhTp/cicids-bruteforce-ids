...
\begin{enumerate}
    ...
    \item \textbf{Điền giá trị thiếu}: Khởi tạo \texttt{SimpleImputer} với chiến lược trung vị (\texttt{strategy='median'}). Giá trị trung vị của từng đặc trưng được tính toán duy nhất trên $\Dtrain$, sau đó được dùng để điền các giá trị NaN trên cả ba tập $\Dtrain$, $\Dval$ và $\Dtest$.
\end{enumerate}
