...
\begin{itemize}
    \item \textbf{Về mặt học thuật}: Đồ án là một trong những công trình đầu tiên tại Việt Nam dũng cảm công bố và phân tích chi tiết sự suy giảm hiệu năng của mô hình học máy trên NIDS chuỗi thời gian, cung cấp bằng chứng thực nghiệm rõ ràng phản bác lại trào lưu "chạy đua F1 > 99\%" thiếu thực tế.
