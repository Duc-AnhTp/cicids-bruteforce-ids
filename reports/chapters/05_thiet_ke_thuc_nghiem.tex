...
Đây là giao thức đánh giá trung tâm của đồ án được triển khai trong \texttt{scripts/run\_remaining.py} và lưu trữ tại \texttt{artifacts/week3\_week4/test\_comparison.csv}:
\begin{itemize}
