...
\begin{enumerate}
    ...
    \item Khoảng thời gian không có gói tin mới vượt quá ngưỡng chờ không hoạt động do cấu hình CICFlowMeter xác định; giá trị cụ thể phụ thuộc vào phiên bản và thiết lập sử dụng.
...
\begin{itemize}
    ...
    \item Vì là văn bản rõ, các gói tin yêu cầu và phản hồi có kích thước ngắn và tương đối cố định. Lưu lượng hướng đi (Fwd) thường có độ lệch chuẩn kích thước gói tin nhỏ.
\end{itemize}
...
Tại mỗi nút phân chia, thuật toán tìm kiếm đặc trưng $j$ và ngưỡng $\theta$ tối ưu nhằm tối đa hóa mức giảm độ không thuần khiết. Chỉ số thường dùng là độ không thuần khiết Gini:
\begin{equation}
