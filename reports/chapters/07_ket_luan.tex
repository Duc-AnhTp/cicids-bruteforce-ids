...
\begin{enumerate}
    ...
    Random Split tạo ra sự chênh lệch hiệu năng rất lớn so với Time-based Split. Trên tập kiểm thử, điểm F1 của Random Forest tăng vọt từ $\RFTestFOne$ (theo thời gian) lên $\RFRandomFOne$ (ngẫu nhiên); tỷ lệ phát hiện SSH tăng từ \RFTestSSHRecall\ lên \RFRandomSSHRecall. Kết quả này khẳng định: việc phân tách ngẫu nhiên trên dữ liệu lưu lượng mạng theo chuỗi thời gian gây ra độ lệch đánh giá quá lạc quan. Nguyên nhân cốt lõi là do sự tương quan mạnh giữa các luồng trong cùng một chiến dịch tấn công bị rò rỉ đồng thời vào cả tập huấn luyện và tập kiểm thử, biến bài toán kiểm thử thành một đánh giá mang tính chất nội suy thay vì phản ánh năng lực khái quát hóa sang các biến thể hoặc mốc thời gian mới.
